...
public final SliderSetting manhattanDim = new SliderSetting("Manhattan dimensions","Manhattan dimensions value.", 3, 0, 2147483647, 1, ValueDisplay.INTEGER);
...
public final SliderSetting modifierCost = new SliderSetting("Cost Modifier","Cost modifier value.", 0.5, 0, 2000, 0.000001, ValueDisplay.DECIMAL);
public final SliderSetting diagonalCost = new SliderSetting("Cost Diagonal Waking","Cost diagonal walking value.", 0.5, 0, 2000, 0.000001, ValueDisplay.DECIMAL);
public final SliderSetting liquidsCost = new SliderSetting("Cost Liquids","Cost liquids value.", 0.5, 0, 2000, 0.000001, ValueDisplay.DECIMAL);
public final SliderSetting slownessCost = new SliderSetting("Cost Slowness","Cost slowness value.", 0.5, 0, 2000, 0.000001, ValueDisplay.DECIMAL);
public final SliderSetting miningCost = new SliderSetting("Cost Mining","Cost mining value.", 0.5, 0, 2000, 0.000001, ValueDisplay.DECIMAL);
public final SliderSetting jumpingCost = new SliderSetting("Cost Jumping","Cost jumping value.", 0.5, 0, 2000, 0.000001, ValueDisplay.DECIMAL);
