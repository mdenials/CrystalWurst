...
public class Mining implements AutoCloseable
{
	private final BlockPos stump;
	private final List<BlockPos> logs;
	private VertexBuffer vertexBuffer;
	
	public Mining(BlockPos stump, List<BlockPos> logs)
	{
		this.stump = stump;
		this.logs = logs;
		compileBuffer();
	...
	public void compileBuffer()
	{
		...
		Box box = new Box(boxMin, boxMin, boxMin, boxMax, boxMax, boxMax).offset(regionOffset);
