	...
	extends HandledScreen<ShulkerBoxScreenHandler>
{
	...
	protected void init()
	{
		...
		if(autoSteal.areButtonsVisible())
		{
			...
			addDrawableChild(ButtonWidget
				.builder(Text.literal("Sort"), b -> steal())
				.dimensions(x + backgroundWidth - 160, y + 4, 50, 12).build());
		}
	 ...
	 */
		private void replaceSlot(final Set<Integer> remainingSlots, final Map<Integer, Integer> oldPosToNewPosMapping, final int cursorOldPosition) {
